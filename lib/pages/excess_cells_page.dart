...
class _ExcessCellsPageState extends State<ExcessCellsPage> {
  ...
  TriangleDirection _commonDirection = TriangleDirection.up; // Most triangles use this
  Set<int> _differentDirectionPositions = {}; // 2 positions with different direction
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  child: direction != null
                      ? Center(
                          child: _buildTriangle(direction),
                        )
                      : null,
                ),
              );
